...
function calculateSectionScore(
  ...
  const questionNamesBySection = questionNames.filter((name) =>
...
function toggleButton(state: RootState): void {
  ...
  const noNextBtnClassIncluded = " sv_next_btn btn-primary";
  const nextButstr = "btn sv_next_btn btn-primary";
  const noPrevBtnClassIncluded = " sv_prev_btn btn-primary";
  const prevButstr = "btn sv_prev_btn btn-primary";
